...
const Banner = () => {
  ...
  return (
    ...
    <div className="bg-center bg-cover h-auto py-16 pb-24 bg-no-repeat"
      ...
      <form onSubmit={searchPage} className="mx-auto border rounded p-4 mt-5 flex flex-col md:flex-row gap-4 items-center justify-center bg-white/60 w-5/6 md:w-4/6">
        <input type="text" placeholder='location' name='location' className='border-2 border-indigo-400 rounded p-3 w-full md:w-48 lg:w-96' />
        <input type="text" name='city' required placeholder='city (ex: dhaka)' className='w-full md:w-36 lg:w-72 border-2 border-indigo-400 rounded p-3' />
