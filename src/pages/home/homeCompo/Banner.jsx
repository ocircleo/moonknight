...
const Banner = () => {
    ...
    return (
        <div>
            <div className="bg-center bg-cover  lg:h-screen" 
        ...
        <TabList className="flex   justify-start mb-4">
          <Tab>
            <button  style={{ textTransform: 'none' }}  className={`relative  btn md:mr-6  shadow-lg   text-xs md:text-base font-semibold
             text-blue-950 pt-3  pb-3 md:pb-11 md:px-6    hover:bg-[#6A94FF] hover:text-white ${tabIndex === 0 ? 'active text-white bg-[#6A94FF]' : ''}`}>
        <div className='flex'>
...
<h2 className='mt-1'>Buy a Property</h2>
          ...
          <Tab>
            <button  style={{ textTransform: 'none' }}  className={`relative  btn md:mr-6  shadow-lg   text-xs md:text-base font-semibold
             text-blue-950 pt-3  pb-3 md:pb-11 md:px-6    hover:bg-[#6A94FF] hover:text-white ${tabIndex === 1 ? 'active text-white bg-[#6A94FF]' : ''}`}>
        <div className='flex'>
...
<h2 className='mt-1'>Rent a Property</h2>
      ...
      <form className=" grid   grid-cols-1 md:grid-cols-2 lg:grid-cols-6 p-5    gap-2 mr-8 md:mr-0 rounded-xl lg:opacity-100     lg:bg-white lg:p-8 shadow-white   md:py-8 md:px-4 ">
